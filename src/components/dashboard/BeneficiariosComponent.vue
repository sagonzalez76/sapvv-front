...
const refrescar = async () => {
    await axios.get('https://sapvv-front.onrender.com/beneficiarys', {
...
const getBeneficiary = async (id) => {
    ...
    await axios.get('https://sapvv-front.onrender.com/beneficiarys/' + id, {
        headers: {
            'Authorization': `Bearer ${token}`,
        },
    })
...
const createBeneficiary = async () => {
    ...
    await axios.post('https://sapvv-front.onrender.com/beneficiarys', formData.value)
        .then(() => {
...
const editBeneficiary = async (id) => {
    ...
    await axios.put(`https://sapvv-front.onrender.com/beneficiarys/${id}`, formData.value)
        .then(() => {
...
const deleteBeneficiary = async (id) => {
    ...
    await axios.delete('https://sapvv-front.onrender.com/beneficiarys/' + id)
        .then(() => {
