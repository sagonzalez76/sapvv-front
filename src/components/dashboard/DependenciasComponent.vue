...
const getProgram = async (id) => {
    ...
    await axios.get('https://sapvv-front.onrender.com/dependencys/' + id, {
        headers: {
            'Authorization': `Bearer ${token}`,
        },
    })
...
const createProgram = async () => {
    ...
    await axios.post('https://sapvv-front.onrender.com/dependencys', formData.value)
        .then(() => {
...
const editProgram = async (id) => {
    ...
    await axios.put(`https://sapvv-front.onrender.com/dependencys/${id}`, formData.value)
        .then(() => {
...
const deleteProgram = async (id) => {
    await getProgram(id)
    await axios.delete('https://sapvv-front.onrender.com/dependencys/' + id)
        .then(() => {
