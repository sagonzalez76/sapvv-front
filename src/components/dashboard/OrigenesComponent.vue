...
const getOrigin = async (id) => {
    ...
    await axios.get('https://sapvv-front.onrender.com/origins/' + id, {
        headers: {
            'Authorization': `Bearer ${token}`,
        },
    })
...
const createOrigin = async () => {
    ...
    await axios.post('https://sapvv-front.onrender.com/origins', formData.value)
        .then(() => {
            alert('Origen Creado')
...
const editOrigin = async (id) => {
    ...
    await axios.put(`https://sapvv-front.onrender.com/origins/${id}`, formData.value)
        .then(() => {
...
const deleteOrigin = async (id) => {
    await getOrigin(id)
    await axios.delete('https://sapvv-front.onrender.com/origins/' + id)
        .then(() => {
