...
const getMunicipality = async (id) => {
    ...
    await axios.get('https://sapvv-front.onrender.com/municipalitys/' + id, {
        headers: {
            'Authorization': `Bearer ${token}`,
        },
    })
...
const createMunicipality = async () => {
    ...
    await axios.post('https://sapvv-front.onrender.com/municipalitys', formData.value)
        .then(() => {
...
const editMunicipality = async (id) => {
    ...
    await axios.put(`https://sapvv-front.onrender.com/municipalitys/${id}`, formData.value)
        .then(() => {
...
const deleteMunicipality = async (id) => {
    ...
    await axios.delete('https://sapvv-front.onrender.com/municipalitys/' + id)
        .then(() => {
