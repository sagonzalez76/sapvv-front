...
const refrescar = async () => {
    await axios.get('https://sapvv-front.onrender.com/programs', {
...
const getProgram = async (id) => {
    ...
    await axios.get('https://sapvv-front.onrender.com/programs/' + id, {
        headers: {
            'Authorization': `Bearer ${token}`,
        },
    })
...
const createProgram = async () => {
    ...
    await axios.post('https://sapvv-front.onrender.com/programs', formData.value)
        .then(() => {
...
const editProgram = async (id) => {
    ...
    await axios.put(`https://sapvv-front.onrender.com/programs/${id}`, formData.value)
        .then(() => {
...
const deleteProgram = async (id) => {
    await getProgram(id)
    await axios.delete('https://sapvv-front.onrender.com/programs/' + id)
        .then(() => {
