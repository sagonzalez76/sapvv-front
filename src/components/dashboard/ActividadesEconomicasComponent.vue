...
const getProgram = async (id) => {
    ...
    await axios.get('https://sapvv-back.onrender.com/economic_activitys/' + id, {
        headers: {
            'Authorization': `Bearer ${token}`,
        },
    })
...
const createProgram = async () => {
    ...
    await axios.post('https://sapvv-back.onrender.com/economic_activitys', formData.value)
        .then(() => {
...
const editProgram = async (id) => {
    ...
    await axios.put(`https://sapvv-back.onrender.com/economic_activitys/${id}`, formData.value)
        .then(() => {
...
const deleteProgram = async (id) => {
    await getProgram(id)
    await axios.delete('https://sapvv-back.onrender.com/economic_activitys/' + id)
        .then(() => {
