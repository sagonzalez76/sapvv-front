...
const refrescar = async () => {
    await axios.get('https://sapvv-front.onrender.com/economic_activitys', {
        ...
        .then((response) => {
            ...
            // console.log(economic_activitys.value);
...
const getProgram = async (id) => {
    ...
    await axios.get('https://sapvv-front.onrender.com/economic_activitys/' + id, {
        headers: {
            'Authorization': `Bearer ${token}`,
        },
    })
...
const createProgram = async () => {
    ...
    await axios.post('https://sapvv-front.onrender.com/economic_activitys', formData.value)
        .then(() => {
            alert('Actividad Economica Creado')
...
const editProgram = async (id) => {
    ...
    await axios.put(`https://sapvv-front.onrender.com/economic_activitys/${id}`, formData.value)
        .then(() => {
            alert('Actividad Economica Actualizado')
...
const deleteProgram = async (id) => {
    await getProgram(id)
    await axios.delete('https://sapvv-front.onrender.com/economic_activitys/' + id)
        .then(() => {
            alert('Actividad Economica Eliminado')
    ...
    <div class="table-responsive small my-4 rounded">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Crear Actividad Economica </h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-floating my-2">
                            <input type="text" class="form-control" id="floatingInputGrid"
                                placeholder="Actividad Economica 1" v-model="formData.name" required>
                            <label for="floatingInputGrid">Nombre del Actividad Economica </label>

                        </div>
                        <div class="form-floating my-2">
                            <input type="text" class="form-control" id="floatingInputGrid"
                                placeholder="Actividad Economica 1" v-model="formData.code" required>
                            <label for="floatingInputGrid">Codigo del Actividad Economica </label>
        ...
        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Editar Actividad Economica
                        </h1>
                    ...
                    <div class="modal-body">
                        <div class="form-floating my-2">
                            <input type="text" class="form-control" id="floatingInputGrid"
                                placeholder="Actividad Economica 1" v-model="formData.name">
                            <label for="floatingInputGrid">Nombre del Actividad Economica</label>

                        </div>
                        <div class="form-floating my-2">
                            <input type="text" class="form-control" id="floatingInputGrid"
                                placeholder="Actividad Economica 1" v-model="formData.code">
                            <label for="floatingInputGrid">Cpdigo de la Actividad Economica</label>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="eliminarModal" aria-hidden="true">
            <div class="modal-dialog ">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="eliminarModal">Seguro deseas eliminar este actividad economica?
                        </h1>
